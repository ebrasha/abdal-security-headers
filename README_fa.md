...
- 🗂️ **اسکن عمیق فایل‌ها:** اسکن اختیاری فایل‌های افزونه و پوسته روی دیسک (حتی اگر الان بارگذاری نشوند) با نوار پیشرفت قابل‌لغو از قرمز تا سبز، فهرست استثناهای قابل‌ویرایش، و امکان محدود کردن اسکن به افزونه و پوستهٔ انتخاب‌شده؛ مدت یادگیری روی حالت دستی می‌رود
...
افزونه به‌طور کامل به این زبان‌ها ترجمه شده است:
